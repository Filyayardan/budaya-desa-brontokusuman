        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="badge" value="{{ old('badge') }}" placeholder="Warisan Budaya Yogyakarta" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                </div>
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Judul Baris 1</label>
                        <input type="text" name="judul_atas" value="{{ old('judul_atas') }}" placeholder="Jelajahi" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Judul Baris 2</label>
                        <input type="text" name="judul_tengah" value="{{ old('judul_tengah') }}" placeholder="Kebudayaan" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Judul Baris 3</label>
                        <input type="text" name="judul_bawah" value="{{ old('judul_bawah') }}" placeholder="Brontokusuman" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi <span class="text-gray-400">(opsional)</span></label>
                    <textarea name="deskripsi" rows="2" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none" placeholder="Mengenal lebih dekat keindahan tradisi...">{{ old('deskripsi') }}</textarea>
                </div>
                {{-- <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tombol 1 Teks</label>
                        <input type="text" name="btn1_teks" value="{{ old('btn1_teks') }}" placeholder="Jelajahi Budaya" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tombol 1 Link (route name)</label>
                        <input type="text" name="btn1_link" value="{{ old('btn1_link') }}" placeholder="budaya" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tombol 2 Teks</label>
                        <input type="text" name="btn2_teks" value="{{ old('btn2_teks') }}" placeholder="Sejarah Kampung" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tombol 2 Link (route name)</label>
                        <input type="text" name="btn2_link" value="{{ old('btn2_link') }}" placeholder="sejarah" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                </div> --}}
            </div>
        </div>
