            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="btn2_teks" value="{{ old('btn2_teks') }}" placeholder="Sejarah Desa" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
                    </div>
                    <div>
