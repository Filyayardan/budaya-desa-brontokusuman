            ...
            <form action="{{ route('admin.budaya.update', $budaya) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        @if ($budaya->gambar)
                            <div class="relative group w-fit mb-2">
                                <img src="{{ asset('storage/' . $budaya->gambar) }}"
                    ...
                    <div>
                        ...
                        @if ($budaya->video)
                            <div class="relative group w-fit mb-2">
                                <div class="w-20 h-14 rounded-lg border border-gray-200 bg-gray-50 flex items-center justify-center text-xs text-gray-500">
