    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form action="{{ route('admin.acara.update', $acara) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="penulis" value="{{ old('penulis', $acara->penulis) }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-gold-500 outline-none">
            </div>
               <div class="mb-4">
            ...
            <div class="mb-6">
                ...
                @if($acara->gambar)
                    <div class="relative group w-fit mb-2">
                        <img src="{{ asset('storage/' . $acara->gambar) }}" class="w-20 h-20 rounded-lg object-cover border border-gray-200">
