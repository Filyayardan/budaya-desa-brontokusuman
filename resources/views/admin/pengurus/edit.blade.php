                ...
                <div>
                    ...
                    <select name="parent_id"
                        ...
                        @foreach ($atasanList ?? [] as $a)
                            <option value="{{ $a->id }}" {{ old('parent_id', $pengurus->parent_id) == $a->id ? 'selected' : '' }}>
                                {{ $a->jabatan }} – {{ $a->nama }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mb-6">
                ...
                @if($pengurus->foto)
                    <div class="relative group w-fit mb-2">
                        <img src="{{ asset('storage/' . $pengurus->foto) }}" class="w-16 h-16 rounded-full object-cover border border-gray-200">
                        <button type="button" data-field="hapus_foto"
                    ...
                    <input type="hidden" name="hapus_foto" class="field-hapus-media" value="">
                @endif
