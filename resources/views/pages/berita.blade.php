...
<section class="header-section relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-main_txt-400 max-w-xl mx-auto">Kabar dan informasi terkini seputar kebudayaan Kampung Brontokusuman</p>
    </div>
</section>
            ...
            <a href="{{ route('berita.detail', $br->id) }}" class="card-hover group">
                <div class="bg-white backdrop-blur rounded-2xl overflow-hidden border border-gold-500/10 hover:border-gold-500/30 h-full">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="font-display text-xl font-bold text-main_txt group-hover:text-gold-300 transition-colors mb-3">{{ $br->judul }}</h3>
                        <p class="text-tertiary text-sm line-clamp-2">{{ Str::limit($br->ringkasan ?? $br->isi, 120) }}</p>
                    </div>
                </div>
            </a>
            @endforeach
