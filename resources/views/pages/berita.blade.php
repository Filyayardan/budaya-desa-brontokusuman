...
@section('content')
    <section class="header-section relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="font-display text-5xl sm:text-6xl font-bold text-main_txt mt-3 mb-4">Berita Terbaru</h1>
            <div class="line-gold w-24 mx-auto mb-6"></div>
            <p class="text-main_txt-400 max-w-xl mx-auto">Kabar dan informasi terkini seputar kebudayaan Kampung
                Brontokusuman</p>
        </div>
    </section>
                                ...
                                <div class="relative h-52 bg-gradient-to-br from-gold-600/20 to-dark-700 overflow-hidden">
                                    ...
                                    @else
                                        <div class="absolute inset-0 flex items-center justify-center"><i
                                                class="fas fa-newspaper text-5xl text-gold-500/20"></i></div>
                                    @endif
                                    @if ($br->featured)
                                        <div class="absolute top-4 left-4">
                                            <span
                                                class="gradient-gold text-dark-950 text-xs font-bold px-3 py-1 rounded-full"><i
                                                    class="fas fa-fire mr-1"></i>Utama</span>
                                        </div>
                                    @endif
                                </div>
                                <div class="p-6">
                                    ...
                                    <h3
                                        ...
                                        {{ $br->judul }}</h3>
                                    <p class="text-tertiary text-sm line-clamp-2">{!! nl2br(e(Str::limit($br->ringkasan ?? $br->isi, 120))) !!}</p>
                                </div>
                            </div>
                        </a>
                    @endforeach
