        ...
        <div class="mt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('berita.detail', $bl->id) }}" class="card-hover group">
                    <div class="bg-white backdrop-blur rounded-xl overflow-hidden border border-gold-500/10 hover:border-gold-500/30">
                        ...
                        <div class="p-5">
                            <h3 class="font-display text-lg font-bold text-main_txt group-hover:text-gold-300 transition-colors mb-2">{{ $bl->judul }}</h3>
