    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
                ...
                <h2 class="font-display text-4xl font-bold text-main_txt mt-3 mb-6">{{ $profil['tentang_judul'] ?? 'Brontokusuman' }}</h2>
                ...
                <div class="bg-white backdrop-blur rounded-2xl border border-main_txt-500/10 p-8">
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-12 h-12 rounded-xl bg-main_txt-500/10 flex items-center justify-center flex-shrink-0"><i class="fas {{ $i['icon'] }} text-main_txt-400"></i></div>
                            <div><span class="text-main_txt-500 text-xs block">{{ $i['label'] }}</span><span class="text-tertiary font-semibold text-sm">{{ $i['value'] }}</span></div>
                        </div>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-24">
            ...
            <div class="bg-white backdrop-blur rounded-2xl border border-main_txt-800/10 p-8">
                ...
                <p class="text-tertiary leading-relaxed">{{ $profil['visi'] }}</p>
            </div>
            @endif
            @if($profil['misi'] ?? null)
            <div class="bg-white backdrop-blur rounded-2xl border border-main_txt-800/10 p-8">
                ...
                <div class="text-tertiary leading-relaxed whitespace-pre-line">{{ $profil['misi'] }}</div>
            </div>
            @endif
        </div>
        @endif
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="card-hover group">
                <div class="bg-white backdrop-blur rounded-2xl overflow-hidden border border-black-500/10 hover:border-gold-500/30 text-center">
