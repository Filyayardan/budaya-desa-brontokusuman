...
class ProfilKampungSeeder extends Seeder
{
    public function run(): void
    {
        $data = [
            ...
            'tentang_isi' => "Kampung Brontokusuman merupakan salah satu kampung yang terletak di Kemantren Mergangsan, Kota Yogyakarta, Daerah Istimewa Yogyakarta. Kampung ini dikenal dengan kekayaan budaya dan tradisi yang masih terjaga hingga saat ini.\n\nBerbagai kesenian tradisional, upacara adat, dan warisan budaya lainnya masih dilestarikan oleh masyarakat setempat menjadi bagian penting dari identitas kampung.",
            'lokasi' => 'Kem. Mergangsan, Yogyakarta',
            'penduduk' => '± 3.000 Jiwa',
            'kemantren' => 'Mergangsan',
            'kota' => 'Yogyakarta',
            'telepon' => '+62 274 XXX XXX',
            'email' => 'info@brontokusuman.id',
            'alamat' => 'Jl. Prawirotaman 2, Brontokusuman, Kem. Mergangsan, Kota Yogyakarta, DI Yogyakarta 55153',
